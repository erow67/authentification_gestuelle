...
public class MainFrame extends javax.swing.JFrame
{
  ...
  public ArrayList<Rect>  detection_contours(Mat inmat, Mat outmat)
  {
    ...
    return rect_array;
        ...
        /*     
        Imgproc.convexityDefects(contours.get(key), hullI, defects);

        Scalar[] mColorsRGB = null;
        Core.rectangle(vv, boundingRect.tl(), boundingRect.br(), mColorsRGB[1], 2);
        Imgproc.drawContours(vv, hullP, key, mColorsRGB[2]);
        */
